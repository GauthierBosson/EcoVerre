...
final class UserLoginAuthenticator extends AbstractFormLoginAuthenticator implements AuthenticatorInterface
{
    ...
    {
        if ($request->getPathInfo() != '/user/login' || $request->getMethod() != 'POST') {
            return false;
        }
